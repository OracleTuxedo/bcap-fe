...
export function convertObjectToString(
  ...
  const fieldNumbers: Array<FieldNumberParam> | undefined =
    Reflect.getMetadata(Meta.FIELD_NUMBER, classInstance);
  const fieldLists:
    | Array<FieldListParam<typeof classInstance>>
    | undefined = Reflect.getMetadata(Meta.FIELD_LIST, classInstance);
